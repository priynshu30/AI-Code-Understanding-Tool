...
const SUGGESTED_QUESTIONS = [
  ...
  'Explain the database schemas and relationships.',
  'What are the key API routes and their purposes?',
  'Walk me through the overall project architecture and data flow.'
];
...
export default function ChatWindow({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-dark-900 relative">
      {/* Header bar */}
      <div className="h-12 border-b border-dark-700 bg-dark-850/50 px-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-mono">
            {activeRepo.chunkCount || 0} code vectors indexed
          </span>
        </div>
      </div>
        ...
        {messages.length === 0 && !isStreaming ? (
          <div className="max-w-2xl mx-auto my-12 text-center">
            ...
            <p className="text-xs text-slate-400 max-w-md mx-auto mb-6">
              Ask any natural-language question. Answers are generated by retrieving relevant code chunks directly from the codebase.
            </p>
          ...
          <>
            {messages.map((msg, index) => (
              ...
              >
                ...
                <div
                  className={`relative rounded-xl p-4 text-sm leading-relaxed max-w-[85%] ${
                    msg.sender === 'user'
            ...
            {isStreaming && (
              <div className="flex gap-3 max-w-4xl mx-auto justify-start">
                ...
                <div className="bg-dark-850 border border-dark-700 text-slate-200 rounded-xl p-4 text-sm leading-relaxed max-w-[85%] shadow-sm">
                  {streamingMessage ? (
                    <div className="prose prose-invert prose-sm max-w-none text-slate-200">
                      <ReactMarkdown remarkPlugins={[remarkGfm]}>
                        {streamingMessage}
      ...
      {/* Chat input box */}
      <div className="p-4 border-t border-dark-700 bg-dark-850/80 backdrop-blur-md">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto relative">
          <input
            ...
            placeholder={`Ask anything about ${activeRepo.repoName}... (e.g. "Where is the router configured?")`}
